export const styles = {
  ...
  codeInline: 'bg-gray-100 px-2 py-1 rounded text-sm font-mono',
  pre: 'bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto',
  prose: 'prose',
  proseGray: 'prose-gray',
  ...
  bgRed50: 'bg-red-50',
  bgRed100: 'bg-red-100',
  bgLinearToB: 'bg-linear-to-b',
  bgLinearToR: 'bg-linear-to-r',
  ...
  // Layout specific
  h16Flex: 'flex h-16 justify-between items-center',

  // Page layouts
  pageContainer: 'min-h-[80vh] flex items-center justify-center py-12 px-4',
  pageMaxW: 'w-full max-w-md',
  sectionPy20: 'py-20',
  containerMaxW7xl: 'mx-auto max-w-7xl px-4 sm:px-6 lg:px-8',

  // Success/Error states
  successIcon: 'w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4',
  errorIcon: 'w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4',
