import { type ComponentType, memo, useContext, useEffect, useRef } from 'react';
...
function StreetViewPanoramaFunctional({
  ...
  useEffect(() => {
    ...
    if (streetViewPanorama !== null) {
      ...
      if (onResize) {
        eventListeners.push(google.maps.event.addListener(streetViewPanorama, 'resize', onResize));
      }
    ...
    if (typeof onLoad === 'function' && streetViewPanorama !== null) {
...
export const StreetViewPanoramaF: ComponentType<StreetViewPanoramaProps> =
  memo<StreetViewPanoramaProps>(StreetViewPanoramaFunctional);
