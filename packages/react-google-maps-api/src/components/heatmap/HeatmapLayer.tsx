...
function HeatmapLayerFunctional({ data, onLoad, onUnmount, options }: HeatmapLayerProps) {
  const map = useContext(MapContext);
  const [instance, setInstance] = useState<google.maps.visualization.HeatmapLayer | null>(null);
...
export const HeatmapLayerF: ComponentType<HeatmapLayerProps> =
  memo<HeatmapLayerProps>(HeatmapLayerFunctional);
