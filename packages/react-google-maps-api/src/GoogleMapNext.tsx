...
export function GoogleMap(props: GoogleMapProps): JSX.Element {
  ...
  const [registeredEvents, setRedirectEvents] = React.useState<google.maps.MapsEventListener[]>([])

  const mapRef = React.useRef<HTMLDivElement>(null)

  React.useEffect(function onMount () {
    const map = new google.maps.Map(mapRef.current as Element, props.options)
    ...
    setRedirectEvents(registeredEvents)
  ...
  React.useEffect(function onUpdate () {
    if (map !== null) {
  ...
  return (
    <div
      ...
      className = { props.mapContainerClassName }
    >
...
// React.PureComponent<, GoogleMapState> {
