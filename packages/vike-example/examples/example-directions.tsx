...
function ExampleDirections({ styles }: Props): React.JSX.Element {
  ...
  const checkDriving = useCallback<React.ChangeEventHandler<HTMLInputElement>>(({ target: { checked } }) => {
    if (checked) {
  ...
  const checkBicycling = useCallback<React.ChangeEventHandler<HTMLInputElement>>(({ target: { checked } }) => {
    if (checked) {
      setDirectionsFormValue((currentValue) => ({
        ...currentValue,
  ...
  const checkTransit = useCallback<React.ChangeEventHandler<HTMLInputElement>>(({ target: { checked } }) => {
    if (checked) {
      setDirectionsFormValue((currentValue) => ({
        ...currentValue,
  ...
  const checkWalking = useCallback<React.ChangeEventHandler<HTMLInputElement>>(({ target: { checked } }) => {
    if (checked) {
      setDirectionsFormValue((currentValue) => ({
        ...currentValue,
    ...
    <div className="map">
        ...
        <div className="d-flex flex-wrap">
          <div className="form-group custom-control custom-radio mr-4">
            <input
              ...
              name="travelMode"
              type="radio"
              checked={directionsFormValue.travelMode === google.maps.TravelMode.DRIVING}
          ...
          <div className="form-group custom-control custom-radio mr-4">
            <input
              ...
              name="travelMode"
              type="radio"
              checked={directionsFormValue.travelMode === google.maps.TravelMode.BICYCLING}
          ...
          <div className="form-group custom-control custom-radio mr-4">
            <input
              ...
              name="travelMode"
              type="radio"
              checked={directionsFormValue.travelMode === google.maps.TravelMode.TRANSIT}
          ...
          <div className="form-group custom-control custom-radio mr-4">
            <input
              ...
              name="travelMode"
              type="radio"
              checked={directionsFormValue.travelMode === google.maps.TravelMode.WALKING}
      ...
      <div className="map-container">
        <GoogleMap
          ...
          onClick={onMapClick}
        >
          {directionsFormValue.destination !== "" && directionsFormValue.origin !== "" && (
