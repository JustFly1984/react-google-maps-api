import React, { memo, useMemo, useState, useCallback, type CSSProperties, ChangeEventHandler } from "react";
import {
  CircleF,
  MarkerF,
  PolygonF,
    ...
    <div className="map">
      <div className="map-settings">
        ...
        <div className="custom-control custom-checkbox mb-3">
          ...
          <label className="custom-control-label" htmlFor="show-polyline-checkbox">
            Show flight path
          </label>
        </div>

        <div className="form-group mb-4">
          <label htmlFor="polyline-options-input">Polyline options (valid JSON):</label>
      ...
      <div className="map-container">
        <GoogleMap id="shapes-example" mapContainerStyle={styles.container} zoom={2} center={mapCenter}>
          {polylineVisible ? <PolylineF path={FLIGHT_PLAN_COORDS} options={po} /> : null}
          ...
          <OverlayViewF position={OVERLAY_VIEW_POSITION} mapPaneName={OVERLAY_MOUSE_TARGET}>
