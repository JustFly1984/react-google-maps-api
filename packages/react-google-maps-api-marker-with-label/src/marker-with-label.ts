...
class MarkerWithLabel () {
  ...
  inherits(MarkerLabel_, this.gMapsApi.OverlayView);
   ...
   * @private
   */
  MarkerLabel_.getSharedCross = function getSharedCross(crossURL) {
    var div;
   ...
   * @private
   */
  MarkerLabel_.prototype.onAdd = function onAdd() {
    var me = this;
   ...
   * @private
   */
  MarkerLabel_.prototype.onRemove = function onRemove() {
    var i;
   ...
   * @private
   */
  MarkerLabel_.prototype.draw = function draw() {
    this.setContent();
    this.setTitle();
    this.setStyles();
  };
   ...
   * @private
   */
  MarkerLabel_.prototype.setContent = function setContent() {
   ...
   * @private
   */
  MarkerLabel_.prototype.setTitle = function setTitle() {
