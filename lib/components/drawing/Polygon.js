...
function (_PureComponent) {
  ...
  function Polygon(props, context) {
    ...
    (0, _MapChildHelper.construct)(_proptypes.PolygonPropTypes, updaterMap, props, polygon);
    polygon.setMap(context[_constants.MAP]);
    _this.state = _defineProperty({}, _constants.POLYGON, polygon);
    ...
    _this.getPaths = _this.getPaths.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Polygon, [{
    ...
    value: function getPath() {
      return this.state[_constants.POLYGON].getMap();
    }
  }, {
    key: "getPaths",
