...
function (_PureComponent) {
  ...
  function Data(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getControlPosition", function () {
      return _this.state[_constants.DATA].getControlPosition();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getControls", function () {
      return _this.state[_constants.DATA].getControls();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDrawingMode", function () {
      return _this.state[_constants.DATA].getDrawingMode();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getFeatureById", function () {
      return _this.state[_constants.DATA].getFeatureById();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMap", function () {
      return _this.state[_constants.DATA].getMap();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getStyle", function () {
      return _this.state[_constants.DATA].getStyle();
    });

    var circle = new google.maps.Data(props.options);
    _this.state = (_this$state = {}, _defineProperty(_this$state, _constants.DATA, circle), _defineProperty(_this$state, "prevProps", (0, _MapChildHelper.construct)(_proptypes.DataPropTypes, updaterMap, props, circle)), _this$state);
  ...
  _createClass(Data, [{
    ...
    value: function componentWillUnmount() {
      ...
      var circle = this.state[_constants.DATA];
    ...
    value: function getDerivedStateFromProps(props, state) {
      return (0, _MapChildHelper.getDerivedStateFromProps)(props, state, this.state[_constants.DATA], eventMap, updaterMap);
    }
  }]);
...
_defineProperty(Data, "propTypes", _proptypes.DataPropTypes);
