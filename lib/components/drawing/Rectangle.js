...
function (_PureComponent) {
  ...
  function Rectangle(props, context) {
    ...
    (0, _MapChildHelper.construct)(_proptypes.RectanglePropTypes, updaterMap, props, rectangle);
    rectangle.setMap(context[_constants.MAP]);
    _this.state = _defineProperty({}, _constants.RECTANGLE, rectangle);
  ...
  _createClass(Rectangle, [{
    ...
    value: function getMap() {
      return this.state[_constants.RECTANGLE].getMap();
    }
  }, {
    key: "getVisible",
