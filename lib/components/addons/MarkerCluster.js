...
function (_PureComponent) {
  ...
  function MarkerClusterer(props, context) {
    ...
    (0, _MapChildHelper.construct)(MarkerClusterer.propTypes, updaterMap, props, markerClusterer);
    markerClusterer.setMap(context[_constants.MAP]);
    _this.state = _defineProperty({}, _constants.MARKER_CLUSTERER, markerClusterer);
    return _this;
  }
