...
function (_PureComponent) {
  ...
  function InfoBox() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(InfoBox)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(InfoBox, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _MapChildHelper.construct)(_proptypes.InfoBoxPropTypes, updaterMap, this.props, infoBox);
      infoBox.setMap(this.context[_constants.MAP]);
      this.setState(function () {
        return _defineProperty({}, _constants.INFO_BOX, infoBox);
      });
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.children !== prevProps.children) {
        (0, _reactDom.unstable_renderSubtreeIntoContainer)(this, _react.Children.only(this.props.children), this.state[_constants.INFO_BOX].getContent());
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      if (infoBox) {
        if (infoBox.getContent()) {
          (0, _reactDom.unmountComponentAtNode)(infoBox.getContent());
        }
...
_defineProperty(InfoBox, "propTypes", _proptypes.InfoBoxPropTypes);
