...
function (_PureComponent) {
  ...
  function FusionTablesLayer(props, context) {
    ...
    (0, _MapChildHelper.construct)(_proptypes.FusionTablesLayerPropTypes, updaterMap, props, fusionTablesLayer);
    fusionTablesLayer.setMap(context[_constants.MAP]);
    _this.state = _defineProperty({}, _constants.FUSION_TABLES_LAYER, fusionTablesLayer);
    return _this;
  }
  ...
  _createClass(FusionTablesLayer, [{
    ...
    value: function getMap() {
      return this.state[_constants.FUSION_TABLES_LAYER].getMap();
    }
  }]);
...
_defineProperty(FusionTablesLayer, "propTypes", _proptypes.FusionTablesLayerPropTypes);
