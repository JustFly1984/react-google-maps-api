...
function (_PureComponent) {
  ...
  function KmlLayer(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getDefaultViewport", function () {
      return _this.state[_constants.KML_LAYER].getDefaultViewport();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMap", function () {
      return _this.state[_constants.KML_LAYER].getMap();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMetadata", function () {
      return _this.state[_constants.KML_LAYER].getMetadata();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getStatus", function () {
      return _this.state[_constants.KML_LAYER].getStatus();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getUrl", function () {
      return _this.state[_constants.KML_LAYER].getUrl();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getZIndex", function () {
      return _this.state[_constants.KML_LAYER].getZIndex();
    });

    var kmlLayer = new google.maps.KmlLayer(props.options);
    _this.state = (_this$state = {}, _defineProperty(_this$state, _constants.KML_LAYER, kmlLayer), _defineProperty(_this$state, "prevProps", (0, _MapChildHelper.construct)(_proptypes.KmlLayerPropTypes, updaterMap, props, kmlLayer)), _this$state);
  ...
  _createClass(KmlLayer, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      return (0, _MapChildHelper.getDerivedStateFromProps)(props, state, this.state[_constants.KML_LAYER], eventMap, updaterMap);
    }
  }]);
...
_defineProperty(KmlLayer, "propTypes", _proptypes.KmlLayerPropTypes);
