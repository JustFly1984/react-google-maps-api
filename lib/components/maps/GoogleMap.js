...
function (_PureComponent) {
  ...
  _createClass(GoogleMap, null, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.map !== null) {
        var prevProps = Object.keys(state.prevProps).length === 0 ? defaultPropNameList.reduce(function (acc, propName) {
        ...
        var registered = (0, _map.map)(eventMap, function (googleEventName, onEventName) {
...
_defineProperty(GoogleMap, "contextType", _GoogleMapProvider.GoogleMapContext);

var _default = (0, _GoogleMapProvider.withGoogleMapContext)(GoogleMap);
