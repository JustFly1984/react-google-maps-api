...
function (_PureComponent) {
  ...
  function BicyclingLayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      _this.bicyclingLayer = new google.maps.BicyclingLayer();
      console.log('BicyclingLayer componentDidMount map: ', _this.props.map);

      _this.bicyclingLayer.setMap(_this.props.map);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMap", function () {
      return _this.bicyclingLayer.getMap();
    });
