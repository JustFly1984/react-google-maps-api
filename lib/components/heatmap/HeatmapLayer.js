...
function (_PureComponent) {
  ...
  function HeatmapLayer(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getData", function () {
      return _this.state[_constants.HEATMAP_LAYER].getData();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getMap", function () {
      return _this.state[_constants.HEATMAP_LAYER].getMap();
    });
    ...
    _this.state = (_this$state = {}, _defineProperty(_this$state, _constants.HEATMAP_LAYER, heatmapLayer), _defineProperty(_this$state, "prevProps", (0, _MapChildHelper.construct)(_proptypes.HeatmapLayerPropTypes, updaterMap, props, heatmapLayer)), _this$state);
  ...
  _createClass(HeatmapLayer, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      return (0, _MapChildHelper.getDerivedStateFromProps)(props, state, this.state[_constants.HEATMAP_LAYER], eventMap, updaterMap);
    }
  }]);
