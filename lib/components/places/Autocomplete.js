...
function (_PureComponent) {
  ...
  function Autocomplete(props, context) {
    ...
    (0, _MapChildHelper.construct)(_proptypes.AutocompletePropTypes, updaterMap, props, autocomplete);
    _this.state = _defineProperty({}, _constants.AUTOCOMPLETE, autocomplete);
    _this.getBounds = _this.getBounds.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getFields = _this.getFields.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(Autocomplete, [{
    ...
    value: function componentDidMount() {
      (0, _MapChildHelper.componentDidMount)(this, this.state[_constants.AUTOCOMPLETE], eventMap);
    }
  }, {
    ...
    value: function getFields() {
      return this.state[_constants.AUTOCOMPLETE].getFields();
    }
  }, {
    key: "getPlace",
    value: function getPlace() {
      return this.state[_constants.AUTOCOMPLETE].getPlace();
    }
  }]);
